...
public class CallManager {
    ...
    public static void main(String[] args) throws ExecuteException, InboundConnectionFailure {
        new CallManager();
    }

    public CallManager() throws ExecuteException, InboundConnectionFailure {
...
//                                exe.say("en", "123456", "number", "pronounced");
                    ...
                    public void onEslEvent(Context ctx, EslEvent event) {
                        ...
                        if ("CHANNEL_HANGUP_COMPLETE".equals(eventname)) {
                            ...
                            System.out.println("variable_effective_caller_id_number :" + dd.get("variable_effective_caller_id_number"));
                        }
                    }
                });
