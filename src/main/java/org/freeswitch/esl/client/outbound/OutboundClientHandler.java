...
class OutboundClientHandler extends AbstractEslClientHandler {
    ...
    public void channelActive(final ChannelHandlerContext ctx) throws Exception {
        ...
        System.out.println("[OutboundClientHandler] Received new connection from server, sending connect message");
    ...
    protected void handleAuthRequest(io.netty.channel.ChannelHandlerContext ctx) {
        ...
        System.out.println("[OutboundClientHandler] Auth request received in outbound mode, ignoring");
    }

    @Override
    protected void handleDisconnectionNotice() {
        System.out.println("[OutboundClientHandler] Received disconnection notice");
    }
}
